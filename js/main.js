$(function(){
    ...
    function onDocumentMouseDown( event ) {
        ...
        var intersects = raycaster.intersectObjects( objects );
		 var intersectie = raycaster.intersectObjects( line1 );
        ...
        var color = (Math.random() * 0xffffff);
		 ...
		 if ( intersectie ) {
            ...
            intersectie.object.material.color.setHex( color );
            
            this.temp = intersectie.object.material.color.getHexString();
            this.name = intersectie.object.name;
            
            $( ".text" ).empty();
            $( ".popup" ).append( "<div class='text'><p>This is my first PopUp" </p></div>" );
            $(".popup").show();
