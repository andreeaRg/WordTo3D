...
for (i = 0; i < 5; i++) {
   ...
   pentagon.push( r * Math.sin(2 * Math.PI * i / 5) ) ;
  }
...
for (i = 0; i < 6; i++) {
    ...
    hexagon.push( r * Math.sin(2 * Math.PI * i / 6) ) ;
  }
...
for (i = 0; i < 7; i++) {
    ...
    heptagon.push( r * Math.sin(2 * Math.PI * i / 7) ) ;
  }
...
for (i = 0; i < 8; i++) {
    ...
    octagon.push( r * Math.sin(2 * Math.PI * i / 8) ) ;
  }
